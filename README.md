...
**Preview:**  
![System Overview](https://github.com/Geekstrange/Deeprotection-WebGUI/tree/main/img/system-overview.png "System Overview Interface")

### 2. Configuration Management
Set basic configurations like language, protection switch, and auto-update.

**Preview:**  
![Configuration Management](https://github.com/Geekstrange/Deeprotection-WebGUI/tree/main/img/config-management.png "Configuration Management Interface")

### 3. Rule Management
Manage protected paths and command interception rules.

**Preview:**  
![Rule Management](https://github.com/Geekstrange/Deeprotection-WebGUI/tree/main/img/rule-management.png "Rule Management Interface")

### 4. Log Viewing
View system protection logs in real time.

**Preview:**  
![Log Viewing](https://github.com/Geekstrange/Deeprotection-WebGUI/tree/main/img/log-viewing.png "Real-time Log View")

### 5. Terminal Tool
Execute system commands for debugging and management.

**Preview:**  
![Terminal Tool](https://github.com/Geekstrange/Deeprotection-WebGUI/tree/main/img/terminal-tool.png "Terminal Tool Interface")
